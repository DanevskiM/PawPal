...
import {
  BEHAVIOR_CHALLENGES, OWNERSHIP_DURATIONS,
  FEEDING_SCHEDULES, ANIMAL_REACTIONS, RegistrationForm,
...
export class RegistrationFormComponent implements OnInit {
  ...
  private readonly stepGroupKeys = [
    'clientInfo', 'petInfo', 'healthInfo', 'behaviorInfo', 'stayInfo',
  ] as const;
  ...
  // HELPERS
  // ============================================================
  get stepIndex(): number { return this.svc.currentStep(); }
  get steps():     { label: string; icon: string }[] { return this.svc.STEP_LABELS; }
}
